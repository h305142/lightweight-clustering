...
for i=1:ep_len%enumerate synthetic datasets based on k
    writeFile=['./results/DYW_ep',num2str(10*ep(i)),'.txt'];
    ...
    for j = 1:times
        %
        tic; 
        [centers,timer(j),maxr]=DYW(...
            data, X.z, k,eta,epsilon,3);
        %
