% generate systhetic datasets with varying k
otl_set = [0.02,0.04,0.06,0.08,0.1];
k_set = [8,12,16,20,24];
len = size(k_set,2);
for i = 1:len
    d = 100;
    ...
    ep = 2;
    create_data(n_size,d,k_set(i),otl_set(1),ep);
end
...
eta = eta(t);
k_standard=k;
filename = ['./datasets_gen_k/k', num2str(k), '_data.mat'];
