...
saveFile = './median_alg3_k_results/alg3_k.mat';
folderPath = './median_alg3_k_results';
if ~isfolder(folderPath)
mkdir(folderPath);
end
% looping for k(different datasets)
for i = 1:k_num %enumerate synthetic datasets based on k
    writeFile = ['./median_alg3_k_results/alg3_k',num2str(k_set(i)),'.txt'];
