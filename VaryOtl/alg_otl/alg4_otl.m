...
saveFile='./alg4_otl_results/alg4_otl.mat';
folderPath = './alg4_otl_results';
if ~isfolder(folderPath)
mkdir(folderPath);
end
for i=1:otl_num
    writeFile=['./alg4_otl_results/alg4_otl',num2str(otl_set(i)),'.txt'];
    ...
    data= X.data; k = X.k; e1=X.e1; e2=X.e2; eta=0.5;delta = 0.9;
    [n_data,~] = size(data);
    tabulate(X.target);
