function []=kmeansmm_size()
%---------configuration-----
addpath('./../../../clustering_code/')
addpath('./../../../clustering_code/baseline/kmedian/kmeansmm');
size_set = [3,4,5];
...
for i=1:size_num%enumerate synthetic datasets based on k
    writeFile=['./results/kmeansmm_size',num2str(size_set(i)),'.txt'];
    ...
    cost_min=inf;
    cost=zeros(1,RPT);timer=zeros(1,RPT);
    for j = 1:RPT
        %
