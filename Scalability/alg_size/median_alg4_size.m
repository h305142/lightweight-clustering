...
saveFile='./median_alg4_size_results/alg4_size.mat';
folderPath = './median_alg4_size_results';
if ~isfolder(folderPath)
mkdir(folderPath);
end
for i=1:size_num
    writeFile=['./median_alg4_size_results/alg4_size',num2str(size_set(i)),'.txt'];
