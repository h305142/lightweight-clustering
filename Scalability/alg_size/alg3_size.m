...
saveFile='./alg3_size_results/alg3_size.mat';
folderPath = './alg3_size_results';
if ~isfolder(folderPath)
mkdir(folderPath);
end
for i=1:size_num
    writeFile=['./alg3_size_results/alg3_size',num2str(size_set(i)),'.txt'];
    ...
    eta_arr = X.eta;     delta_arr = X.delta;    
